...
import featuresdiagonal from "../assets/images/security.gif";
      ...
      >
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-bgDark1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            <span className="block-subtitle">Privacy Armor</span>
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl block-big-title">
              Secure &amp; Encrypted Communications
            </h2>
            <p className="mb-16 text-secondaryText leading-loose">
            In a world where privacy is paramount, your meetings are shielded with top-tier encryption. With end-to-end security, you can rest easy knowing that your conversations are private and protected.
            </p>
            <a href="https://synapsestream.netlify.app/">
              <button
